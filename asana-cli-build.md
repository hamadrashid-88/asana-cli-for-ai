# Asana CLI Build — Complete Source Files

This file contains all source code for the Asana CLI project.
Target folder: `C:\Users\Gaming\Documents\Code-Repos\asana-cli\`
...
```env
ASANA_ACCESS_TOKEN=2/1206442081160871/1213977696830069:322143a14f33d77a915691c6cd311407
...
## FILE: petech_business/.agents/skills/asana-management/SKILL.md

> This file goes in the workspace: `c:\Users\Gaming\Documents\Code-Repos\petech_business\.agents\skills\asana-management\SKILL.md`
...
1. Copy `asana-cli.js` to `C:\Users\Gaming\Documents\Code-Repos\asana-cli\`
2. Copy `.env` to `C:\Users\Gaming\Documents\Code-Repos\asana-cli\`
3. Copy `.gitignore` to `C:\Users\Gaming\Documents\Code-Repos\asana-cli\`
4. Copy `SKILL.md` to `petech_business\.agents\skills\asana-management\SKILL.md`
5. Test: `node C:\Users\Gaming\Documents\Code-Repos\asana-cli\asana-cli.js my-tasks`
6. Disable Asana MCP in `mcp_config.json` (add `"disabled": true`)
